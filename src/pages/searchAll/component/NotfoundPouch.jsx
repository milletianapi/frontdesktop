    ...
    return (
        <div className="w-[806px] px-[15px] left-0 top-[356px] bg-white">
            <div
                    ...
                    <div className="flex">
                        {notFoundArray.map((_, index) => (
                            <div key={index} className={"flex items-center"}>
                                <div className={"w-[23px] h-[23px] bg-black"}></div>
                ...
                <button className={"ml-2 min-w-[23px] h-[23px] button1 middle"}>▼</button>
            </div>
            <div
                className="w-[776px] h-72 bg-white rounded-[10px] border border-[#9f7394] py-5 flex justify-center text-3xl">
                검색 결과가 없습니다.
            </div>
        </div>
    )
